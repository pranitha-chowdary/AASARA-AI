...
import { ShiftActivation } from './ShiftActivation';
...
export function Dashboard() {
        ...
        <header className="bg-slate-900 border-b border-slate-800 sticky top-0 z-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
            <div className="flex items-center gap-3">
              <AasaraLogo size="md" animated={true} />
              <div>
                <div className="text-purple-500 font-semibold">AASARA ADMIN CONTROL</div>
  ...
  if (currentStep === 1) {
    return (
      <div className="min-h-screen bg-slate-950">
        <header className="bg-slate-900 border-b border-slate-800 sticky top-0">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
            <div className="flex items-center gap-3">
              <AasaraLogo size="md" animated={true} />
              <div>
                <div className="text-blue-500 font-semibold">Platform Linking</div>
        ...
        <header className="bg-slate-900 border-b border-slate-800 sticky top-0">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
            <div className="flex items-center gap-3">
              <AasaraLogo size="md" animated={true} />
              <div>
                <div className="text-blue-500 font-semibold">Weekly Plan & Payment</div>
    ...
    return (
      <div className="min-h-screen bg-slate-950">
        <header className="bg-slate-900 border-b border-slate-800 sticky top-0">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
            <div className="flex items-center gap-3">
              <AasaraLogo size="md" animated={true} />
              <div>
                <div className="text-blue-500 font-semibold">Welcome, {user?.fullName}</div>
        ...
        <div className="px-4 sm:px-6 lg:px-8 py-6 space-y-6">
          {/* Shift Activation Card - Always at the top */}
          <ShiftActivation onShiftActive={(shift) => {
            console.log('Shift activated:', shift);
          }} />
